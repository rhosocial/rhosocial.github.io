/**
 * index/en-us.js — Homepage English dictionary
 * Spec: merge into window.I18N['en-us'] (same key overwrites)
 */
window.I18N = window.I18N || {};
window.I18N['en-us'] = Object.assign(window.I18N['en-us'] || {}, {
  meta: { name: 'English' },
  ...
  /* Architecture · Internal three layers (Expression → Dialect → Backend) */
  arch: {
  ...
  /* Component Architecture · ActiveRecord + Backend two layers */
  arch_comp: {
